...
class AdherentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adherent" do
    assert_difference('Adherent.count') do
      post adherents_url, params: { adherent: { email: @adherent.email, nom: @adherent.nom, prenom: @adherent.prenom, tel: @adherent.tel } }
    end
  ...
  test "should update adherent" do
    patch adherent_url(@adherent), params: { adherent: { email: @adherent.email, nom: @adherent.nom, prenom: @adherent.prenom, tel: @adherent.tel } }
